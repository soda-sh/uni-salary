...
# window to append a professor to an existing professor list (excel file)
class Ui_profInsertionForm(QtWidgets.QWidget):
    ...
    # appends the professor to the chosen excel file
    def appendProf(self):
        ...
        # putting professor details in a list
        prof = []
        ...
        # appending professor to the file
