...
class Ui_newProfForm(object):
    ...
    def retranslateUi(self, newProfForm):
        ...
        self.profBase.setItemText(0, _translate("newProfForm", "رتبه یک"))
        self.profBase.setItemText(1, _translate("newProfForm", "رتبه دو"))
        ...
        self.profGrade.setItemText(0, _translate("newProfForm", "پایه یک"))
        self.profGrade.setItemText(1, _translate("newProfForm", "پایه دو"))
