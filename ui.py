...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.profSelectionFrame.setGeometry(QtCore.QRect(480, 50, 301, 51))
        ...
        self.profSelectionConfirmBtn.setGeometry(QtCore.QRect(580, 110, 89, 25))
        ...
        self.profDetailsBox.setGeometry(QtCore.QRect(170, 20, 281, 121))
        ...
        self.thesisInsertionBox.setGeometry(QtCore.QRect(500, 160, 271, 111))
    ...
    def retranslateUi(self, mainWindow):
        ...
        self.profSelectionLabel.setText(_translate("mainWindow", "کد ملی استاد"))
        ...
        self.profPosition.setItemText(0, _translate("mainWindow", "راهنما"))
        self.profPosition.setItemText(1, _translate("mainWindow", "مشاور"))
        self.profPosition.setItemText(2, _translate("mainWindow", "داور"))
        self.profPosition.setItemText(3, _translate("mainWindow", "ناظر"))
        self.profPositionLabel.setText(_translate("mainWindow", "مسولیت استاد"))
